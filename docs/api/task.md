...
- 其他说明：
    ...
    2. 数据源为MongoDB时会忽略掉数据库:admin,local,config
    3. 目前只支持MySQL,MongoDB,Elasticsearch
    4. 不同数据源,返回值略有不同
  ...
  "source": [
    {
      ...
      // 同步模式:direct,dump,stream,replica,empty
      "sync_mode": "direct",
...
```json5
{
  ...
  "data": {
    ...
    "list": [
      {
        "Id": "f90528d9-691e-11ec-9284-00ffb182f508",
        "Desc": "from mysql to elasticsearch",
        "State": "null",
        "LatestRunStartAt": 0,
        "LatestRunEndAt": 0,
