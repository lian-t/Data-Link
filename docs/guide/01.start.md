...
```bash
# 下载仓库
git clone git@github.com:lian-t/data-link-2.0.git
# 构建bin
cd ./app/datalink
...
# 调试 go run ./app/datalink/main.go  -f config.toml
```
  ...
  "resource": [
    {
      ...
      "host": "10.10.10.10",
      "port": "33017",
      "dsn": "mongodb://admin:94215b0cb86d9ceb@10.10.10.10:33017/?connect=direct"
    },
    {
      "id": "no1000002",
      "desc": "mysql本地服务",
